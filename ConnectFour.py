...
board_img = pygame.image.load("./Images/Connect4Board.png")
arrow_img = pygame.image.load("./Images/ArrowPointer.png")
arrow_img_yellow = pygame.image.load("./Images/ArrowPointerYellow.png")
yellow_img = pygame.image.load("./Images/YellowChip.png")
red_img = pygame.image.load("./Images/RedChip.png")
